...
public class ContactController {
    ...
    public String contactSave(Contact contact, HttpServletResponse response) throws IOException, InterruptedException {
        ...
        contactService.insert(contact);
         ...
         out.print("<script language='javascript'>alert('反馈成功!');</script>");
//         response.getWriter().write("进行写入");

         System.out.println("已经进行了反馈");
